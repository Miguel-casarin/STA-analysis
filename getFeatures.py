...
class Circuits_features:
    ...
    def compute_logic_levels(self):
        ...
        # algoritmo iterativo: só define nível quando TODAS as entradas
        # estão resolvidas (da PI ou de instâncias já niveladas)
        levels = {}
        changed = True
...
if __name__ == "__main__":
    ...
    debug = Circuits_features(file, lib)
    levels = debug.compute_logic_levels()
    deep = debug.comput_deep()
    fanin = debug.fan_in()
    fanout = debug.fan_out()
    print("logic levels:", levels)
    print("deep:", deep)
    print("fan_in:", fanin)
    print("fan_out:", fanout)